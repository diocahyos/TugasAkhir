				...
				<div class="table-responsive">
					<table class="table table-bordered table-responsive-lg">
						...
						<tbody class="text-center">
							<tr>
								<td><?= $data[2][1][1]->nama; ?> 150 g</td>
							</tr>
							<tr>
								<td><?= $data[2][1][2]->nama; ?> 80 g</td>
							</tr>
							<tr>
								<td><?= $data[2][1][3]->nama; ?> 50 g</td>
							</tr>
							<tr>
								<td><?= $data[2][1][4]->nama; ?> 250 g</td>
							</tr>
							<tr>
								<td><?= $data[2][1][5]->nama; ?> 150 g</td>
							</tr>
						</tbody>
					</table>
				</div>
			...
			<div class="col-sm-4">
				<div class="table-responsive">
					<table class="table table-bordered table-responsive-lg">
						...
						<tbody class="text-center">
							<tr>
								<td><?= $data[2][1][6]->nama; ?> 150 g</td>
							</tr>
							<tr>
								<td><?= $data[2][1][7]->nama; ?> 80 g</td>
							</tr>
							<tr>
								<td><?= $data[2][1][8]->nama; ?> 50 g</td>
							</tr>
							<tr>
								<td><?= $data[2][1][9]->nama; ?> 250 g</td>
							</tr>
							<tr>
								<td><?= $data[2][1][10]->nama; ?> 150 g</td>
							</tr>
						</tbody>
					</table>
				</div>
			...
			<div class="col-sm-4">
				<div class="table-responsive">
					<table class="table table-bordered table-responsive-lg">
						...
						<tbody class="text-center">
							<tr>
								<td><?= $data[2][1][11]->nama; ?> 150 g</td>
							</tr>
							<tr>
								<td><?= $data[2][1][12]->nama; ?> 80 g</td>
							</tr>
							<tr>
								<td><?= $data[2][1][13]->nama; ?> 50 g</td>
							</tr>
							<tr>
								<td><?= $data[2][1][14]->nama; ?> 250 g</td>
							</tr>
							<tr>
								<td><?= $data[2][1][15]->nama; ?> 150 g</td>
							</tr>
						</tbody>
					</table>
				</div>
				...
				<div class="col-sm-4">
					<div class="table-responsive">
						<table class="table table-bordered table-responsive-lg">
							...
							<tbody class="text-center">
								<tr>
									<td><?= $data[2][2][1]->nama; ?> 150 g</td>
								</tr>
								<tr>
									<td><?= $data[2][2][2]->nama; ?> 80 g</td>
								</tr>
								<tr>
									<td><?= $data[2][2][3]->nama; ?> 50 g</td>
								</tr>
								<tr>
									<td><?= $data[2][2][4]->nama; ?> 250 g</td>
								</tr>
								<tr>
									<td><?= $data[2][2][5]->nama; ?> 150 g</td>
								</tr>
							</tbody>
						</table>
					</div>
				...
				<div class="col-sm-4">
					<div class="table-responsive">
						<table class="table table-bordered table-responsive-lg">
							...
							<tbody class="text-center">
								<tr>
									<td><?= $data[2][2][6]->nama; ?> 150 g</td>
								</tr>
								<tr>
									<td><?= $data[2][2][7]->nama; ?> 80 g</td>
								</tr>
								<tr>
									<td><?= $data[2][2][8]->nama; ?> 50 g</td>
								</tr>
								<tr>
									<td><?= $data[2][2][9]->nama; ?> 250 g</td>
								</tr>
								<tr>
									<td><?= $data[2][2][10]->nama; ?> 150 g</td>
								</tr>
							</tbody>
						</table>
					</div>
				...
				<div class="col-sm-4">
					<div class="table-responsive">
						<table class="table table-bordered table-responsive-lg">
							...
							<tbody class="text-center">
								<tr>
									<td><?= $data[2][2][11]->nama; ?> 150 g</td>
								</tr>
								<tr>
									<td><?= $data[2][2][12]->nama; ?> 80 g</td>
								</tr>
								<tr>
									<td><?= $data[2][2][13]->nama; ?> 50 g</td>
								</tr>
								<tr>
									<td><?= $data[2][2][14]->nama; ?> 250 g</td>
								</tr>
								<tr>
									<td><?= $data[2][2][15]->nama; ?> 150 g</td>
								</tr>
							</tbody>
						</table>
					</div>
